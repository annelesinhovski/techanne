      ...
      <PageCadastro>
        ...
        <Container>
          <Headline>
            ...
            <p>
              <strong>Previsão de próxima turma:</strong> Junho/2022
              <br />
            </p>
            <Button
              onClick={() =>
                window.location.assign('https://pay.hotmart.com/B66020103U')
              }
            >
              Quero participar
            </Button>
        ...
        <Beneficios>
          <ul>
            <li>
              <p>
                <span>7</span>Módulos <small>(20+ aulas)</small>
              </p>
            </li>
            <li>
              <p>
        ...
        <Price>
          ...
          <Container>
            <PriceDescription>
              <Valor>
                <p>
                  <strike>De: R$ 997</strike>
                  Por
                </p>
                <h5>
                  <span>R$</span>497<small>,00</small>
                </h5>
              </Valor>
              <Pacote>
                ...
                <ul>
                  ...
                  <li>
                    <p>Até 15 dias para pedir reembolso</p>
                  </li>
                </ul>
              </Pacote>
            </PriceDescription>
